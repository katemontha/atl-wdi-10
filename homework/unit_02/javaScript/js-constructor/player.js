...
console.log(player.feedTamagotchi(newTamagotchi1));
console.log(player.medicateTamagotchi(newTamagotchi2));
console.log(player.knockOutTamagotchi(newTamagotchi1))
